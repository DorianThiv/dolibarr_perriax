 ...
 */
class perriaxbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "perriax@perriax";
    public $boxlabel;
    public $depends = array("perriax");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/perriax/class/perriax.class.php";
